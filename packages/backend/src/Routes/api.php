...
Route::prefix($prefix . '/' . $workpointPrefix)
    ...
    ->group(function () {
        ...
        Route::get('history/user/{userId}/summary', [WorkpointController::class, 'historyUserSummary']);
        Route::get('history/user/{userId}/logs', [WorkpointController::class, 'historyUserLogs']);
